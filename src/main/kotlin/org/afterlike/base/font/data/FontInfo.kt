...
/**
 * Font information data class for the standalone implementation
 */
data class FontInfo(
    val atlas: Atlas,
    val metrics: Metrics,
...
/**
 * Atlas information for font rendering
 */
data class Atlas(
    val type: String,
...
/**
 * Glyph information for individual characters
 */
class Glyph(
    val unicode: Int,
    val advance: Float,
